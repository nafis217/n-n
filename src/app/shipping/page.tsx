      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="p-6 bg-white border border-neutral-200 shadow-sm space-y-3">
            <div className="text-xs font-mono text-neutral-500 uppercase font-bold">Standard Delivery</div>
            <h3 className="font-display text-lg uppercase font-bold text-black">Dhaka Metro</h3>
            <p className="font-mono text-xl font-bold text-black">৳80 / Free over ৳10k</p>
          ...
          <div className="p-6 bg-white border border-neutral-200 shadow-sm space-y-3">
            <div className="text-xs font-mono text-neutral-500 uppercase font-bold">Nationwide Courier</div>
            <h3 className="font-display text-lg uppercase font-bold text-black">Outside Dhaka</h3>
            <p className="font-mono text-xl font-bold text-black">৳150 / Free over ৳10k</p>
            <p className="text-xs text-neutral-600 font-sans">
          ...
          <div className="p-6 bg-white border border-neutral-200 shadow-sm space-y-3">
            <div className="text-xs font-mono text-black uppercase font-bold flex items-center gap-1">
              <Sparkles className="w-3.5 h-3.5 text-black" /> Priority Dispatch
            </div>
            <h3 className="font-display text-lg uppercase font-bold text-black">Express Same-Day</h3>
            <p className="font-mono text-xl font-bold text-black">৳150 Flat</p>
            <p className="text-xs text-neutral-600 font-sans">
        ...
        {/* Packaging & Safety */}
        <div className="p-8 bg-white border border-neutral-200 shadow-sm space-y-6 text-xs sm:text-sm text-neutral-600 leading-relaxed font-sans">
          <h2 className="font-display text-xl uppercase font-bold text-black">
