  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-black py-12 md:py-20 px-4 sm:px-8 md:px-12">
      <div className="max-w-6xl mx-auto space-y-12">
        {/* Header */}
        <div className="text-center space-y-3 max-w-2xl mx-auto pb-8 border-b border-neutral-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 bg-white border border-neutral-200 shadow-sm">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h3 className="font-display text-lg uppercase tracking-wider font-bold text-black">
                  Message Dispatched to Atelier Team
                </h3>
                <p className="text-xs text-neutral-600 font-sans max-w-md mx-auto leading-relaxed">
                  Thank you, <strong className="text-black">{name}</strong>. Your correspondence has been routed to our client care director. We will reply to <strong className="text-black">{email}</strong> shortly.
                </p>
                <button
                  onClick={() => {
                    setSubmitted(false);
                  ...
                  className="px-6 py-3 border border-neutral-300 text-xs font-mono uppercase tracking-wider text-black hover:border-black transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <h3 className="font-display text-sm uppercase tracking-widest font-bold text-black pb-3 border-b border-neutral-200">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-black text-white hover:bg-neutral-800 disabled:opacity-50 font-display font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 transition-all shadow-sm"
                >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-6 sm:p-8 bg-white border border-neutral-200 shadow-sm space-y-4">
              <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-wider text-neutral-500 font-bold">
              ...
              <div className="text-xs font-mono text-neutral-500 space-y-1 pt-2 border-t border-neutral-200">
