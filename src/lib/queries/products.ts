    ...
    reviews: [
      {
        ...
        rating: 5,
        date: '2026-09-10',
        title: 'Clean luxury polo for everyday wear',
        comment: 'The collar stays crisp and the gold piping on the collar and cuffs gives it a subtle luxury edge.',
        verified: true,
      },
    ],
    shortDescription: 'High-density knit technical polo featuring fine contrast-tipped rib collar and minimalist chest emblem.',
    description: 'Designed for effortless day-to-night versatility. Pairs seamlessly with tailored trousers or denim for sharp urban silhouettes.',
    details: [
      '260 GSM double-combed compact piqué cotton',
      'Gold tipped knit collar and sleeve cuffs',
      'Reinforced side split hems',
      'Tailored in Dhaka Atelier'
    ],
    care: ['Machine wash cold gentle', 'Do not tumble dry', 'Iron low heat'],
    storeAvailability: { gulshan: 15, tejgaon: 10, banani: 5 },
    isBestSeller: true,
    isNewArrival: true,
    isFeatured: true,
  },
