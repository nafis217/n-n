...
const SAMPLE_ORDERS: Order[] = [
  {
    ...
    items: [
      ...
      {
        id: 'prod-pant-black',
        title: 'Architectural Pleated Formal Trouser',
        price: 8900,
        currency: 'BDT',
  ...
  },
  {
    ...
    items: [
      {
        id: 'prod-shirt-white',
        title: 'Signature Oxford Button-Down Shirt (Crisp White)',
        price: 5900,
        currency: 'BDT',
        image: '/images/products/product1_white_1.jpg',
        quantity: 2,
        selectedSize: 'L',
        selectedColor: 'Optic Crisp White',
      },
    ],
    subtotal: 9600,
    discount: 0,
